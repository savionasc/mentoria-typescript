  ...
  static async get({url = "", method = "", body = {}}) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (body) {
        ...
        auxBody = JSON.stringify(body);
      }
      request.send(auxBody);
    })
  }
}
...
async function criarRequestToken () {
  requestToken = await HttpClient.get({
